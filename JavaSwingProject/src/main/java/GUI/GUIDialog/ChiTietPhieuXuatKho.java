...
public class ChiTietPhieuXuatKho implements ActionListener{
 ...
 public void xuatFilePDFSanPham(int maPhieuXuat) {
    FileOutputStream file = null;
          try {
            com.itextpdf.text.Font fontChung = new com.itextpdf.text.Font(BaseFont.createFont("C:\\Users\\Admin\\OneDrive\\Documents\\NetBeansProjects\\DoAnJavaNhom\\JavaSwingProject\\src\\main\\java\\Others\\Font\\SVN-Times New Roman.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED),14);
            com.itextpdf.text.Font fontDam=new com.itextpdf.text.Font(BaseFont.createFont("C:\\Users\\Admin\\OneDrive\\Documents\\NetBeansProjects\\DoAnJavaNhom\\JavaSwingProject\\src\\main\\java\\Others\\Font\\SVN-Times New Roman Bold.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED),18);
